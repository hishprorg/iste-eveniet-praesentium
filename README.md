# @hishprorg/iste-eveniet-praesentium

![CI](https://github.com/hishprorg/iste-eveniet-praesentium/workflows/CI/badge.svg)
[![NPM version](https://img.shields.io/npm/v/@hishprorg/iste-eveniet-praesentium.svg?style=flat)](https://www.npmjs.com/package/@hishprorg/iste-eveniet-praesentium)
...
`@hishprorg/iste-eveniet-praesentium` is fully *reentrant* and *graph-based*. You can load
...
To install `@hishprorg/iste-eveniet-praesentium`, simply use npm:

```
npm i @hishprorg/iste-eveniet-praesentium
```
...
It demonstrates how to use `@hishprorg/iste-eveniet-praesentium` to load functions / plugins in order.


```js
'use strict'

const app = require('@hishprorg/iste-eveniet-praesentium')()
...
## API
  ...
  * <a href="#constructor"><code><b>@hishprorg/iste-eveniet-praesentium()</b></code></a>
  ...
  * <a href="#express"><code>@hishprorg/iste-eveniet-praesentium.<b>express()</b></code></a>
  * <a href="#toJSON"><code>@hishprorg/iste-eveniet-praesentium.<b>toJSON()</b></code></a>
  * <a href="#prettyPrint"><code>@hishprorg/iste-eveniet-praesentium.<b>prettyPrint()</b></code></a>

-------------------------------------------------------
<a name="constructor"></a>

### @hishprorg/iste-eveniet-praesentium([instance], [options], [started])

Starts the @hishprorg/iste-eveniet-praesentium sequence.
...
require('@hishprorg/iste-eveniet-praesentium')(server)
...
The `@hishprorg/iste-eveniet-praesentium` function can also be used as a
constructor to inherit from.
```js
function Server () {}
const app = require('@hishprorg/iste-eveniet-praesentium')(new Server())
...
```js
import boot from '@hishprorg/iste-eveniet-praesentium'
...
```js
const server = {}
const app = require('@hishprorg/iste-eveniet-praesentium')(server)
...
### @hishprorg/iste-eveniet-praesentium.express(app)

Same as:

```js
const app = express()
const @hishprorg/iste-eveniet-praesentium = require('@hishprorg/iste-eveniet-praesentium')

@hishprorg/iste-eveniet-praesentium(app, {
  expose: {
    use: 'load'
  }
})
...
### @hishprorg/iste-eveniet-praesentium.toJSON()
...
```js
const @hishprorg/iste-eveniet-praesentium = require('@hishprorg/iste-eveniet-praesentium')()
@hishprorg/iste-eveniet-praesentium.on('preReady', () => {
  @hishprorg/iste-eveniet-praesentium.toJSON()
})
```
...
### @hishprorg/iste-eveniet-praesentium.prettyPrint()
...
const @hishprorg/iste-eveniet-praesentium = require('@hishprorg/iste-eveniet-praesentium')()
@hishprorg/iste-eveniet-praesentium.on('preReady', () => {
  console.log(@hishprorg/iste-eveniet-praesentium.prettyPrint())
})
```
...
```
@hishprorg/iste-eveniet-praesentium 56 ms
├── first 52 ms
├── second 1 ms
└── third 2 ms
```
